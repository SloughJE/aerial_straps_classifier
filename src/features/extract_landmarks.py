...
def extract_landmarks(input_source, output_destination, is_video=True, write_output=True):
    ...
    if is_video:
        ...
        while cap.isOpened():
            ...
            landmarks = extract_landmarks_from_frame(frame_rgb)
...
# Example usage:
# extract_landmarks("input_video.mp4", "output_video.mp4") 
# extract_landmarks("input_photo.jpg", "output_photo.jpg", is_video=False) 
